      ...
      <div className="m-8 pt-24 md:m-12 md:pt-28 lg:pt-32 lg:mt-0 lg:mx-32 lg:mb-4 lg:flex lg:gap-16 lg:items-center lg:w-auto 2xl:mx-60 2xl:mb-20 2xl:pt-44">
        <div className="lg:w-1/2">
          <div>
            ...
            <p className="dark:text-white leading-7 dark:font-light text-sm md:text-xl/8 lg:text-sm/7 2xl:text-base/7 lg:w-lg">Titulaire d’une Licence en publicité et marketing et actuellement en fin de formation en Développement Web et Web mobile (Bac+2), je prépare une formation de Concepteur Développeur d’Applications (Titre professionnel de niveau 6 – Bac+3/4) <strong>en alternance, à partir d’octobre 2025</strong> .</p>
