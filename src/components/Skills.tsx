  ...
  return (
    <div className="flex gap-4 flex-wrap justify-center xl:gap-8">
      {skills.map((skill, index) => (
        <div
          key={index}
          className="group relative flex flex-col gap-2 w-[30%] md:max-w-28 items-center border-2 border-primary p-4 pb-2 rounded-md cursor-pointer duration-300 hover:scale-110 shadow-lg"
        >
          <img
            src={skill.icon}
